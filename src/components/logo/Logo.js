  ...
  return (
    <SVG2 id="logo-svg" viewBox="0 0 200 70">
      <radialGradient id="radial-gradient">
        <stop offset="10%" stop-color="#63000a" />
        <stop offset="95%" stop-color="#b80013" />
      </radialGradient>
      <LogoScene id="logo-scene">
        <g id="layer1" transform="translate(-67.605284,-100.84629)">
          <g aria-label="109🗲149" id="text968">
            <OuterStrokeLayer>
              <path
        ...
        <g id="fill-layer" transform="translate(-67.605284,-100.84629)">
          <FillLayer>
            <use href="#first_1" />
          </FillLayer>
          <FillLayer>
        ...
        <g id="inner-stroke-layer" transform="translate(-67.605284,-100.84629)">
          <InnerStrokeLayer>
            <use href="#first_1" />
          </InnerStrokeLayer>
          <InnerStrokeLayer>
        ...
        <g id="main-stroke-layer" transform="translate(-67.605284,-100.84629)">
          <MainStrokeLayer>
            <use href="#first_1" />
          </MainStrokeLayer>
          <MainStrokeLayer>
